...
init()
# in this version you needed to install numpy to solve the system of linear equations
# but you are able not to install it in the new version because there is a solver 
# function in the script itself !
